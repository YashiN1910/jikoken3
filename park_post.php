  ...
  <div class="task-contents wrapper">
    <article>
      <header class="post-info">
        <h2 class="post-title">遊び場で発言</h2>
      </header>
      <div class="post-task">
        <form action="park_post_chk.php" method="POST">
          <textarea name="park_text" maxlength="100"></textarea>
          <input type="submit" class="button" name="park_post" value="投稿" />
        </form>
      </div>
    </article>
