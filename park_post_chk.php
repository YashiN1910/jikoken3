...
$strText = translation_nomulish($strText);
$strText = mysqli_real_escape_string($db_link, $strText);

//SQL文の作成
$strSQL = " insert into park_tbl(cus_id,cus_name,park_date,park_text) ";
...
if ($db_result == false) {
    ...
    //insertの成功
    //遷移
    header('Location: http://localhost/hew01/park.php');
    exit;
}
